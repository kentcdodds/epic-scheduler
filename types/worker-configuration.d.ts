/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts --env production` (hash: 3e0f4f2edcf6794841e26aa0fc48fd43)
// Runtime types generated with workerd@1.20260305.0 2026-01-31 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker/index");
		durableNamespaces: "MCP" | "ScheduleRoom";
	}
	interface Env {
		APP_DB: D1Database;
		ASSETS: Fetcher;
		...
		SCHEDULE_ROOM: DurableObjectNamespace<import("../worker/index").ScheduleRoom>;
	}
}
